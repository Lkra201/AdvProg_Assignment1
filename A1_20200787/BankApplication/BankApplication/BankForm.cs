...
namespace BankApplication
{
    public partial class BankForm : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            if (radInvestment.Checked)
            {
                accountNumber = Bank.NextAccountNumber();
                Account account = new InvestmentAccount(accountNumber);
                bank.AddAccount(account);
            }
            else if (radioOmni.Checked)
            {
                accountNumber = Bank.NextAccountNumber();
                Account account = new OmniAccount(accountNumber);
                bank.AddAccount(account);
            }
            else
            {
                accountNumber = Bank.NextAccountNumber();
                Account account = new EverydayAccount(accountNumber);
                bank.AddAccount(account);                
            }
        ...
        private void radInvestment_CheckedChanged(object sender, EventArgs e)
        {
